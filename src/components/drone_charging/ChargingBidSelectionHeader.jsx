...
class ChargingBidSelectionHeader extends Component {
  constructor(props) {
    super(props);
    ...
    this.sortOptions = {
      ...
      highestChargingVelocity: 'Highest charging velocity',
      ...
      <div className="bid-selection-header-wrapper">
        ...
        >
          ...
          <ul className="sort-options__list">
            ...
            <li
              title={this.sortOptions.shortestDistance}
              className={
                sortOptionSelected === this.sortOptions.shortestDistance
                  ? 'sort-options__list--selected'
                  : ''
              }
              onClick={this.handleSortOptionClick}
            ...
            <li
              title={this.sortOptions.highestChargingVelocity}
              className={
                sortOptionSelected === this.sortOptions.highestChargingVelocity
                  ? 'sort-options__list--selected'
                  : ''
              }
              onClick={this.handleSortOptionClick}
...
export default ChargingBidSelectionHeader;
